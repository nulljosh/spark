...
Note: earlier test target appreview@heyitsmejosh.com was an App Review demo account, not a mailbox Joshua reads. heyitsmejosh.com has MX records (Namecheap + primitive.dev) but appreview@ status is unknown. Future email tests should use Joshua's personal addresses (jatrommel@gmail.com, trommatic@icloud.com) only.
