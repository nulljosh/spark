...
- [x] **Domain fault CLOSED 2026-08-24.** Set `MAIL_FROM=noreply@epiphany.heyitsmejosh.com` via `wrangler pages secret put` — reusing the already-verified Resend domain instead of verifying `sparkjar.heyitsmejosh.com`. No DNS work needed. Sparkjar does not need its own sending domain.
